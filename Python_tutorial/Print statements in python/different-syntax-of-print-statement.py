...
print(a+b+c)#will not allocate any spaces between the numbers and only allowed for the same type of variables.
...
print("this is \"python\".")#escape case where\ is used before the inner double qoutes.